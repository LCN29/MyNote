...
#### 配置
![Alt '图片'](https://github.com/LCN29/Picture-Repository/blob/master/MyNote/Java/JavaJar/slf4j+logback/logback-config01.png?raw=true)
...
##### Appender(重点)
![Alt '图片'](https://github.com/LCN29/Picture-Repository/blob/master/MyNote/Java/JavaJar/slf4j+logback/logback-config02.png?raw=true)
